...
const projects = [
  ...
  {
    id: 2,
    title: "Navkar Commercial Complex",
    ...
    year: "2022",
    description:
      "A modern 5-storey commercial structure with basement parking, high-speed elevators, retail ground floor, and fully integrated fire safety systems.",
    image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=900&q=80",
    tag: "Commercial",
  },
  {
    id: 3,
    title: "Aryan Office Park",
    ...
    year: "2023",
    description:
      "Turnkey office development with open-plan workspaces, modular meeting rooms, server room, and a premium client-facing reception. Delivered in 3 phased handovers.",
